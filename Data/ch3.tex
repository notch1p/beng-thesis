...
\begin{definition}[Skolemization]
  ...
  \begin{equation}
    \skolem(\forall \bar{\rpnt{tv}}.\, \bar{\pi} \Rightarrow \rpnt{ty}) =
    [\bar{\rpnt{tv}} \mapsto \overline{\mathsf{sk}_\rpnt{tv}}](\rpnt{ty})
  \end{equation}
...
\begin{definition}[刚性变量集合/栈 rigid set/stack]
  ...
  \begin{equation}
    \begin{aligned}
      \pushRigid(\bar{\rpnt{tv}}) &: \quad \rigid := \rigid \cup \bar{\rpnt{tv}};\quad
      \mathit{stack} := \bar{\rpnt{tv}} ::  \mathit{stack} \\[-5pt]
