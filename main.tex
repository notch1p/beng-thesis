...
\hypersetup{ colorlinks=true
  ...
  , urlcolor=black
  , citecolor=black
  , pdftitle={TinyTheorem: A prototype for a dependently-typed programming language with theorem proving}
  , pdfauthor={Evan Gao}
  , pdfkeywords={programming language, type theory, theorem prover, compiler}
}
