...
\logo{\includegraphics[height=.8cm]{Style/Figures/SCNUBadge}}
...
\begin{frame}
  ...
  \centering\includegraphics[scale=.8]{assets/Lambda_Cube.pdf}
  \begin{itemize}
...
def recBool {α : Type} 
  ...
  : (t : Bool) -> motive t := fun t => if t then brT else brF
\end{minted}
\onslide<3->{
\begin{itemize}
